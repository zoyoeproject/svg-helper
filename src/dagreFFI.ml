...
external set_edge_label: ffi_graph -> edge_cb ->unit  = "setDefaultEdgeLabel" [@@bs.send]
external nodes: ffi_graph -> string array = "nodes" [@@bs.send]
external add_node: ffi_graph -> node_name -> 'a node_size -> unit = "setNode" [@@bs.send]
external get_node: ffi_graph -> node_name -> 'a node_size = "node" [@@bs.send]
external add_edge: ffi_graph -> node_name -> node_name -> unit = "setEdge" [@@bs.send]
