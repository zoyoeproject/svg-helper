let mk_line style (x1,y1) (x2,y2) =
  Printf.sprintf "<line x1='%f' y1='%f' x2='%f' y2='%f' class='%s' />"
    x1 y1 x2 y2 style

let mk_arc_curve style (x1,y1) (x2,y2) (cx,cy) =
  Printf.sprintf "<path d='M %f %f Q %f %f, %f %f' class='%s'/>"
    x1 y1 cx cy x2 y2 style
...
let mk_bezier_curve style s e ctrl_start ctrl_end =
  ...
  Printf.sprintf "<path d='M %f %f C %f %f, %f %f, %f %f' class='%s'/>"
    sx sy csx csy cex cey ex ey style
...
let connect_horizontal style s e =
  ...
  Printf.sprintf "<path d='M %f %f C %f %f, %f %f, %f %f S %f %f, %f %f' class='%s'/>"
    sx sy csx csy cmx cmy mx my cex cey ex ey style
